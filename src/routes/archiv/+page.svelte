...
<svelte:head>
	<title>Archiv - Kosten-Tool</title>
</svelte:head>

<div class="mb-6">
	<h1 class="mb-2 text-3xl font-black text-neutral-900">Archiv</h1>
	<p class="text-neutral-600">
		Hier findest du alle abgeschlossenen Monate ({data.closedMonths.length})
	</p>
</div>
				...
				<div class="flex items-center justify-between p-5">
					<div class="flex-1">
						...
						<div class="mt-2 flex items-center gap-2">
							<span class="text-sm text-neutral-600">Endsaldo:</span>
						...
						<div class="mt-1 flex items-center gap-2">
							<span class="text-xs text-neutral-500">
								Abgeschlossen am {new Date(closedMonth.closed_at).toLocaleDateString('de-DE')}
							</span>
						</div>
					</div>
...
{:else}
	<div class="rounded-2xl border-2 border-dashed border-neutral-300 bg-neutral-50 p-12 text-center">
		...
		<h2 class="mb-2 text-xl font-bold text-neutral-700">Noch keine archivierten Monate</h2>
		<p class="text-neutral-500">
			Abgeschlossene Monate erscheinen hier automatisch
		</p>
	</div>
{/if}
