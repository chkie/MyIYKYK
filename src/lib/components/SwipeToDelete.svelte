<script lang="ts">
	...
	const deleteButtonOpacity = $derived(Math.min(Math.abs(swipeDistance) / 100, 1));
</script>

<div class="relative overflow-hidden">
	<!-- Delete Background (revealed during swipe) -->
	<div
		class="bg-danger-500 absolute inset-y-0 right-0 flex items-center justify-end px-6"
