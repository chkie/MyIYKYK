...
<div
	...
	class="from-primary-500 to-primary-700 fixed inset-0 z-9999 flex items-center justify-center bg-linear-to-br p-6"
			...
			{#each profiles as profile}
				...
				>
					<div class="flex items-center gap-4">
						<!-- Avatar -->
						<div
							class="from-primary-400 to-primary-600 flex h-16 w-16 items-center justify-center rounded-full bg-linear-to-br text-white transition-transform group-hover:scale-110"
						>
						...
						<!-- Arrow -->
						<svg
							class="text-primary-500 h-6 w-6 transition-transform group-hover:translate-x-1"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
